  ...
  return (
    <Fragment>
      ...
      <Card className={classes.card}>
        <CardActionArea component={RouterLink} to='/learn'>
          <CardContent>
      ...
      <Card className={classes.card}>
        <CardActionArea component={RouterLink} to={data.review === 0 ? '' : '/review'}>
          <CardContent>
            <Typography gutterBottom variant='h5' component='h2'>
      ...
      <Card className={classes.card}>
        <CardActionArea component={RouterLink} to={data.record === 0 ? '' : '/record'}>
          <CardContent>
            <Typography gutterBottom variant='h5' component='h2'>
